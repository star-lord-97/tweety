            ...
            <div class="col-md-8">
                ...
                <form method="POST" action="{{ route('login') }}">
                    ...
                    <div class="mb-6">
                        ...
                        <input type="email" class="border border-gray-400 p-2 w-full" name="email" id="email" autocomplete="email" value="{{ old('email') }}" required>
                    ...
                    <a class="text-xs text-gray-700" href="{{ route('password.request') }}">Forgot your password?</a>
                </form>
            </div>
        </div>
    </div>
